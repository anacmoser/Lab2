...
### 1.
Solicite a nota final de um aluno (entre 0 e 10).
...
### 2.
Solicite um **ano** e verifique se ele é **bissexto**.
...
### 4.
Peça uma **letra do alfabeto** e informe se ela é:
...
### 6.
**Contar números positivos digitados.**
...
### 8.
**Encontrar o maior número digitado.**
...
- Utilize um **laço `while`** para contar **quantos dígitos** ele possui.
...
Peça ao usuário para escolher um idioma:
